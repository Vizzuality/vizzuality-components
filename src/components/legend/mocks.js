    ...
    layers: [
      {
        ...
        dataset: 'ccbcaf7b-1619-4298-8275-b135d1e8e04e',
        description:
          'Time it takes to travel to the nearest city in 2015. Units are minutes, hours, days, and months.',
        application: ['rw'],
        iso: [],
        provider: 'gee',
        ...
        legendConfig: {
          url:
            'https://api.resourcewatch.org/v1/query/098b33df-6871-4e53-a5ff-b56a7d989f9a?sql=SELECT%20name_1%20as%20x,%20area_ha%20as%20y%20FROM%20gadm28_adm1%20WHERE%20type_1%20IN%20(%27County%27)%20%20ORDER%20BY%20area_ha%20desc%20LIMIT%2015',
    ...
    layers: [
      {
        ...
        layerConfig: {
          ...
          pulseConfig: {
            ...
            sql:
              'SELECT st_transform(the_geom_webmercator,32663) as the_geom_webmercator, year, time_precision, event_type, event_date, actor1, actor2, country, location, source, notes, fatalities FROM soc_016_conflict_protest_events WHERE year=2017 ORDER by event_type desc ',
            urlTemplate:
            ...
            layers: [
              {
                options: {
                  ...
                  cartocss:
                    '#layer {marker-width:4; marker-opacity:1; marker-line-width:0.3; marker-line-color:#FFF; marker-line-opacity:1; marker-allow-overlap: true} [event_type="Violence against civilians"]{marker-fill:#6a3d9a;}  [event_type = "Riots/Protests"]{marker-fill:#cab2d6;} [event_type = "Violence against civilians"]{marker-fill:#8dd3c7;}  [event_type = "Battle-No change of territory"]{marker-fill:#b15928;} [event_type = "Remote violence"]{marker-fill:#e31a1c;} [event_type = "Strategic development"]{marker-fill:#fb9a99;}  [event_type = "Battle-Government regains territory"]{marker-fill:#33a02c;} [event_type="Battle-Non-state actor overtakes territory"]{marker-fill:#b2df8a;}  [event_type="Non-violent transfer of territory"]{marker-fill:#1f78b4;}  [event_type="Headquarters or base established"]{marker-fill:#a6cee3;} ',
                  sql:
                    "SELECT * FROM soc_016_conflict_protest_events WHERE (event_date > current_date - interval '30 day') ",
                },
                type: 'mapnik',
              },
            ],
    ...
    layers: [
      {
        ...
        layerConfig: {
          ...
          body: {
            styleType: 'sld',
            sldValue:
              '<RasterSymbolizer>    <ColorMap  type="values" extended="false" >        <ColorMapEntry color="#ffffff" quantity="0" label="" opacity="0" />        <ColorMapEntry color="#228B22" quantity="1" label="" opacity="0" />    <ColorMapEntry color="#98AFC7" quantity="2" label="" />     <ColorMapEntry color="#4863A0" quantity="3" label="" />    </ColorMap></RasterSymbolizer>',
          },
        },
        legendConfig: {
          type: 'basic',
    ...
    layers: [
      {
        ...
        layerConfig: {
          body: {
            ...
            maxZoom: 12,
            metadata:
              'https://production-api.globalforestwatch.org/v1/gfw-metadata/tree_cover_loss',
            minZoom: 3,
            options: {
              useCors: true,
            },
            url:
              'https://storage.googleapis.com/wri-public/Hansen17/tiles/hansen_world/v1/tc{thresh}/{z}/{x}/{y}.png',
          },
